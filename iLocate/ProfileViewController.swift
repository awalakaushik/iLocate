...
class ProfileViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    //function to update the image in firebase DB of the user
    func save() {
...
//    func uploadImage(_ sender: Any) {
    ...
    func tapRecognize(){
        ...
        //Take Photo
        pickOption.addAction(UIAlertAction(title: "Take Photo", style: UIAlertActionStyle.default, handler: {(action) in #imageLiteral(resourceName: "loginuser")
            self.openCamera()
        }))
        //Delete Photo
        pickOption.addAction(UIAlertAction(title: "Delete Photo", style: UIAlertActionStyle.destructive, handler: nil))
        //Cancel Button
